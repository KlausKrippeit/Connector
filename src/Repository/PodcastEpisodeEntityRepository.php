...
/**
 * @extends ServiceEntityRepository<PodcastEpisodeEntity>
 */
class PodcastEpisodeEntityRepository extends ServiceEntityRepository
{
    public function __construct(ManagerRegistry $registry)
    {
        parent::__construct($registry, PodcastEpisodeEntity::class);
    }

    public function findByGuid(string $guid): ?PodcastEpisodeEntity
    {
